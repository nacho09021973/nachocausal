...
> laws and the general expectation that larger samples can increase
> resolution have clear precedents. The internal scoped audit of the three
> frozen targets P1–P3 found no exact equivalent of the S1 all-\(N\)
> class-sum span or of the specified antisymmetric-orbit statement, while
> identifying substantial partial precursors. Its verdict is
> `PRIORITY_NOT_REFUTED`, not a novelty certificate. An external specialist
> review remains necessary before making any affirmative priority claim.
