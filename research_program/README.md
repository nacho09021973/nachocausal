...
PR011 certificó `PAIR_DISTINGUISHABLE_AT_TRACTABLE_N` en `n=4` y `n=5` vía `HELLINGER_FALLBACK`
(`ε ≤ 0.00461`, `ε ≤ 0.00576`). Escalera `n ∈ {6,7,8}` y estimación de masa abiertas.
